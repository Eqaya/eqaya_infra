...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  # /sitemap.xml is generated by the backend from the DB (public contractor/
  # verifier profiles + static pages) so it never goes stale. Same routing as
  # /share/*; the backend sets its own Cache-Control (1h).
  ordered_cache_behavior {
